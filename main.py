...
from FPC_Functions import loadSimData, loadVivoData, normSpecsMax, divideDev, shuffleData, get2Chann, get1Chann
from FPC_Functions import getMag, window1024, toFids, toSpecs, corrFShift, corrPShift
...
# # VARIABLE SET-UP
# ########################################################################################################################
# modelTypes = ["realReal", "compComp"]    # still need to do realReal and compComp
# waterTypes, snrTypes, netTypes = ["Mix", "None", "Pos"], ["10", "5", "2_5"], ["freq", "phase"]
...
#
#         # Normalization
#         on_all_specs_dev, off_all_specs_dev = normSpecsMax(on_dev, off_dev)
#         on_all_specs_devFC, off_all_specs_devFC = normSpecsMax(on_devFC, off_devFC)
#         on_all_specs_test, off_all_specs_test = normSpecsMax(on_test, off_test)
#         on_all_specs_testFC, off_all_specs_testFC = normSpecsMax(on_testFC, off_testFC)
#
...
offsetSize, netTypes = ["None"], ["freq", "phase"]
...
# Test based on offset size (small, medium, large)
        for size in offsetSize:
            ...
            modelLoadName = f"{net}_Sim2_5_PosWater_{model_name}_FINAL_SimForVivo"
